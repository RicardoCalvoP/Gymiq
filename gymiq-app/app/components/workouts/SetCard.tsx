...
type SetCardProps = {
  set: Set;
  editable?: boolean;
  onChange?: (changes: Partial<Set>) => void;
  rowIndex?: number;
};

export default function SetCard({ set, editable = false, onChange, rowIndex = 0 }: SetCardProps) {
    ...
    >
      ...
      {editable && (
        <Pressable
          ...
          onPress={() => {
            onChange && onChange({ completed: !set.completed });
